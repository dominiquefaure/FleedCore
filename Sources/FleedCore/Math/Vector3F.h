#ifndef __FLEEDCORE_MATH_VECTOR3F_H__
#define __FLEEDCORE_MATH_VECTOR3F_H__
...
namespace FleedCore
{
	...
	*/
	struct Vector3F
	{
		...
		*/
		FORCE_INLINE Vector3F( FFloat32 a_value );
		...
		*/
		FORCE_INLINE Vector3F( FFloat32 a_x , FFloat32 a_y , FFloat32 a_z );
		...
		*/
		FORCE_INLINE static FFloat32 Dot( const Vector3F& a_v1 , const Vector3F& a_v2 );
		...
		* @return			the Dot Product
		*/
		FORCE_INLINE FFloat32 Dot( const Vector3F& a_vector )const;
		...
		*/
		FORCE_INLINE void Set( FFloat32 a_x , FFloat32 a_y , FFloat32 a_z );
		...
		*/
		FORCE_INLINE FFloat32 GetLength()const;
		...
		*/
		FORCE_INLINE FFloat32 GetSquaredLength()const;
		...
		*/
		FORCE_INLINE FBool Normalize( FFloat32 a_tolerance = DEFAULT_TOLEARANCE_VALUE );
		...
		*/
		FORCE_INLINE FBool IsNormalized()const;
		...
		*
		*/
		FORCE_INLINE FBool IsZero()const;

		/*
		* Check if this Vector is 0, or really close to it
		*/
		FORCE_INLINE FBool IsAlmostZero( FFloat32 a_tolerance = DEFAULT_TOLEARANCE_VALUE );
		...
		*/
		FORCE_INLINE FBool Equals( const Vector3F& a_vector , FFloat32 a_tolerance = DEFAULT_TOLEARANCE_VALUE )const;
	...
	public:
		...
		* @return			The result vector.
		*/
		FORCE_INLINE Vector3F operator+( FFloat32 a_value )const;
		...
		* @return			The scaled vector
		*/
		FORCE_INLINE Vector3F operator*( FFloat32 a_scale )const;
		...
		* @param copy of this vector after multiplication
		*/
		FORCE_INLINE Vector3F operator*=( FFloat32 a_scale );
		...
		*/
		FORCE_INLINE FBool operator==( const Vector3F& a_vector )const;
