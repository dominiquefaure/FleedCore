...
namespace FleedCore
{
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE Vector3F::Vector3F( FFloat32 a_value )
	{
		x													=	a_value;
		y													=	a_value;
		z													=	a_value;
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE Vector3F::Vector3F( FFloat32 a_x , FFloat32 a_y , FFloat32 a_z )
	{
		x													=	a_x;
		y													=	a_y;
		z													=	a_z;
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE FFloat32 Vector3F::Dot( const Vector3F& a_v1 , const Vector3F& a_v2 )
	{
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE FFloat32 Vector3F::Dot( const Vector3F& a_vector )const
	{
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE void Vector3F::Set( FFloat32 a_x , FFloat32 a_y , FFloat32 a_z )
	{
		x													=	a_x;
		y													=	a_y;
		z													=	a_z;
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE FFloat32 Vector3F::GetLength()const
	{
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE FFloat32 Vector3F::GetSquaredLength()const
	{
		return ( ( x * x ) + ( y* y ) + ( z * z ) );
	}
	//----------------------------------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE FBool Vector3F::Normalize( FFloat32 a_tolerance )
	{
		FFloat32 t_squareValue								=	GetSquaredLength();
		...
		if( t_squareValue > a_tolerance )
		{
			...
			FFloat32 t_scale								=	1.0f / sqrtf( t_squareValue );
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE FBool Vector3F::IsNormalized()const
	{
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE FBool Vector3F::IsZero()const
	{
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE FBool Vector3F::IsAlmostZero( FFloat32 a_tolerance )
	{
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE FBool Vector3F::Equals( const Vector3F& a_vector , FFloat32 a_tolerance )const
	{
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE Vector3F Vector3F::operator+( FFloat32 a_value )const
	{
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE Vector3F Vector3F::operator*( FFloat32 a_scale )const
	{
	...
	FORCE_INLINE Vector3F Vector3F::operator/( FFloat32 a_scale )const
	{
		const FFloat32 t_scale								=	1.0f / a_scale;
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE Vector3F Vector3F::operator*=( FFloat32 a_scale )
	{
		x													*=	a_scale;
		y													*=	a_scale;
		z													*=	a_scale;
	...
	//----------------------------------------------------------------------------------------------------
	FORCE_INLINE FBool Vector3F::operator==( const Vector3F& a_vector )const
	{
		return ( ( x == a_vector.x ) && ( y == a_vector.y ) && ( z == a_vector.z ) );
	}
	//----------------------------------------------------------------------------------------------------
