...
namespace FleedCore
{
	...
	//---------------------------------------------------------------------------------------------
	BOOL WinMainLauncher::Init( FleedApplication* a_application , HINSTANCE a_hInstance, int a_nCmdShow )
	{
	...
	//---------------------------------------------------------------------------------------------
	int WinMainLauncher::Run( FleedApplication* a_application , HINSTANCE a_hInstance, int a_nCmdShow )
	{
